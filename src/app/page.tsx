  ...
  return (
    <div className="bg-black text-slate-100">
      <header className="px-20 py-5 flex items-center justify-between">
        ...
        <a
          href="https://github.com/skueee/dynastik"
          target="_blank"
        ...
        <div className="flex flex-col gap-6 p-6 rounded-xl bg-gray-800">
          ...
          <div className="w-full flex flex-col gap-2">
            <ListEntry
              ...
              href="/docs/pages/npm/monthly-downloads"
            />
          </div>
        </div>
      </div>
...
export function ListEntry({ text, href }: ListEntryProps) {
  return (
    <Link
      href={href}
      className="hover:bg-gray-700 items-center justify-between flex px-2 rounded-full w-full h-full "
    >
